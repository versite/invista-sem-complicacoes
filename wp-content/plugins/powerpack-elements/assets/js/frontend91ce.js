(function ($) {
    ...
    var ImageSliderHandler = function ( $scope, $ ) {
        var $carousel            = $scope.find( '.pp-image-slider' ).eq( 0 ),
			...
			PPSliderUpdate( $carousel, '.pp-image-slider', 'slick' );
			...
			var $fancybox_thumbs   = $carousel.parent().data('fancybox-class');
			var $fancybox_axis	   = $carousel.parent().data('fancybox-axis');

			console.log( $fancybox_axis );
        
            $($lightbox_selector).fancybox({
				loop:               'yes' === elementSettings.loop,
				arrows:             'yes' === elementSettings.lightbox_arrows,
    ...
    var MagazineSliderHandler = function ( $scope, $ ) {
        var $carousel            = $scope.find( '.pp-magazine-slider' ).eq( 0 ),
			...
			PPSliderUpdate( $carousel, '.pp-magazine-slider', 'slick' );
    };
    ...
    var VideoHandler = function ($scope, $) {
        var $video_play         = $scope.find( '.pp-video-play' );
    ...
    var VideoGalleryHandler = function ($scope, $) {
        ...
        if ( elementSettings.layout === 'carousel' ) {
			...
			PPSliderUpdate( $carousel, '.pp-video-gallery', 'slick' );
        }
	};
